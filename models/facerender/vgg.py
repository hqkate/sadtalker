...
from models.facerender.var_init import default_recurisive_init, KaimingNormal
...
def vgg19(num_classes=1000, batch_norm=True, phase="train", pretrained=False, **kwargs):
    """
    ...
    """
    net = VGG(
        cfg["19"], num_classes=num_classes, batch_norm=batch_norm, phase=phase, **kwargs
    )
    return net


if __name__ == "__main__":
    vgg = vgg19(phase="test")
