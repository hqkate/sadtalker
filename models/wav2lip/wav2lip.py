...
class Wav2Lip(nn.Cell):
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.CellList(
            [
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        32, 32, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                    Conv2d(
                        32, 32, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        64, 64, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                    Conv2d(
                        64, 64, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        128, 128, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                    Conv2d(
                        128, 128, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        256, 256, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                    Conv2d(
                        256, 256, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        512, 512, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                ),
                nn.SequentialCell(
        ...
        self.face_decoder_blocks = nn.CellList(
            [
                ...
                nn.SequentialCell(
                    ...
                    Conv2d(
                        384, 384, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
                    Conv2d(
                        384, 384, kernel_size=3, stride=1, padding=1, use_residual=True
                    ),
        ...
        self.output_block = nn.SequentialCell(
            ...
            nn.Conv2d(32, 3, kernel_size=1, stride=1, padding=0, has_bias=True),
            nn.Sigmoid(),
        )
