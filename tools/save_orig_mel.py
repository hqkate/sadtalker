...
inputs_path = '/disk1/katekong/sadtalker/data_train/audio/'  #wav_dir
wav_paths = Get_img_paths(inputs_path)

org_dir = '/disk1/katekong/sadtalker/data_train/audio/'
save_dir = '/disk1/katekong/sadtalker/data_train/orig_mel/'
